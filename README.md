...
Разработать микросервис для хранения и управления связками "телефон-адрес". Такой сервис может использоваться для кеширования часто запрашиваемой информации. Также проверить [проблемы с telegram](telegram_bot_issues).
